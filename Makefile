...
deploy-sepolia:
	@forge script script/DeployOurToken.s.sol:DeployToken --rpc-url $(SEPOLIA_RPC_URL) --private-key $(PRIVATE) --etherscan-api-key $(ETHERSCAN_API_KEY) --broadcast --verify -vvv

deploy-stake:
	@forge script script/DeployStaking.s.sol:DeployToken --rpc-url $(SEPOLIA_RPC_URL) --private-key $(PRIVATE) --etherscan-api-key $(ETHERSCAN_API_KEY) --broadcast --verify -vvv

generateInput:
	@forge script script/GenerateInput.s.sol:GenerateInput --rpc-url $(SEPOLIA_RPC_URL) --private-key $(PRIVATE) -vvv
